...
urlpatterns = [
    ...
    url(r'^circle/(?P<circle_id>[0-9]+)/adduser/$', views.add_users_to_circle, name="add_users_to_circle"),
    url(r'^circle/(?P<circle_id>[0-9]+)/removeuser/$', views.remove_user_from_circle, name="remove_user_from_circle"),
