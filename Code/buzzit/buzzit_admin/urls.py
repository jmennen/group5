...
urlpatterns = [
    ...
    url(r'^report/(?P<user_id>[0-9]+)/user/', views.UserReportDetailsView.as_view(), name="report_user"),
    url(r'^report/(?P<user_id>[0-9]+)/user/save$', views.report_user, name="save_report_user"),
