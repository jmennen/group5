...
urlpatterns = [
    ...
    url(r'^deletecircle', views.deleteCircleView.as_view(), name="deletecircle"), # add new delete circle
    url(r'^createcircle', views.createCircle.as_view(), name="createcircle"),
