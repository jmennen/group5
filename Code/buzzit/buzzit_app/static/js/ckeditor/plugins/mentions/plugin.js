...
CKEDITOR_mentions.prototype.timeout_callback = function (args) {
    ...
    $.get("http://127.0.0.1:8000/messaging/search/user/" + str + "/json", {}, function (rsp) {
        ...
        $('.mention-users').click(function (e) {
            ...
            link.href = "#";
            link.textContent = symbol + username;
        ...
        init: function (editor) {
            ...
            editor.on('contentDom', function (e) {
                ...
                editable.attachListener(editable, 'keypress', function (evt) {
                    ...
                    if (typed_char === '@' || typed_char === '#' || mentions.observe === 1) {
                         ...
                         */
                        if ((mentions.char_input.length > 0 && (typed_char === '#' || typed_char === '@' || typed_char === ' ')) || mentions.char_input.length > 11) {
                            mentions.stop_observing();
                        } else {
